      ...
      <div class="container">
        ...
        <div class="cards-grid">
          <article class="info-card">
            ...
            <p>Menerbitkan sertifikat digital secara cepat, profesional, dan siap diverifikasi keasliannya.</p>
          </article>
          <article class="info-card">
            <span class="icon-circle icon-purple">◇</span>
            <h3>Digital Signature</h3>
            <p>Setiap sertifikat dilindungi dengan digital signature untuk menjaga integritas dan mencegah pemalsuan sertifikat.</p>
          </article>
          <article class="info-card">
            <span class="icon-circle icon-blue">✓</span>
            <h3>Verifikasi Publik</h3>
            <p>Cek keaslian sertifikat kapan saja secara online tanpa perlu membuat akun atau login ke sistem.</p>
          </article>
        </div>
